...
const Navbar = () => {
    return (
        <div>
            <nav className="navbar navbar-expand-lg navbar-transparent container pt-4">
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <p className="m-3" style={{ border: "1px solid #3AB9B5", padding: "5px", borderRadius: "50%" , color:"#3AB9B5" }}>58</p>
                            <button className='btn' style={{backgroundColor :"#3AB9B5" , color:"#fff"}}>Connect Telegram</button>
